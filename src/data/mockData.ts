...
export const mockData: MockData = {
  "chips": [
    { "id": "chip_mvp10", "label": "10분 MVP" },
    { "id": "chip_vibe_loop", "label": "Vibe 루프" },
    { "id": "chip_agent_blueprint", "label": "Agent 설계도" },
    { "id": "chip_tools_mcp", "label": "툴 연결(MCP/API)" },
    { "id": "chip_automation", "label": "자동화 레시피(n8n/Make)" },
    { "id": "chip_rag_ctx", "label": "RAG·기억·컨텍스트" },
    { "id": "chip_eval_guard", "label": "평가·테스트·가드레일" },
    { "id": "chip_ops", "label": "배포·운영" },
    { "id": "chip_postmortem", "label": "회고·삽질 노트" }
  ],
  "layout": {
    ...
    "weeklyRankingIds": ["itm_y_mcp_20", "itm_y_langgraph_course", "itm_w_menugen", "itm_d_n8n_tutorial"],
    "collections": [
      {
        "id": "col_vibe_starter",
  ...
  "items": [
    {
      ...
      "chipIds": ["chip_agent_blueprint", "chip_rag_ctx"],
      "badges": ["HOT"],
      "minutesMock": 47,
    ...
    },
    {
      ...
      "source": "YouTube",
      "author": "Tech channel (YouTube)",
      "chipIds": ["chip_tools_mcp", "chip_mvp10"],
      "badges": ["NEW"],
      "minutesMock": 2,
    ...
    },
    {
      ...
      "chipIds": ["chip_mvp10", "chip_vibe_loop"],
      "badges": ["입문"],
      "minutesMock": 10,
    ...
    },
    {
      ...
      "source": "YouTube",
      "author": "Tech channel (YouTube)",
      "chipIds": ["chip_vibe_loop", "chip_mvp10"],
      "badges": ["인기"],
      "minutesMock": 18,
    ...
    },
    {
      ...
      "source": "YouTube",
      "author": "Tech channel (YouTube)",
      "chipIds": ["chip_automation", "chip_mvp10"],
      "badges": ["추천"],
      "minutesMock": 45,
    ...
    },
    {
      ...
      "source": "YouTube",
      "author": "Tech channel (YouTube)",
      "chipIds": ["chip_automation", "chip_ops"],
      "badges": ["NEW"],
      "minutesMock": 30,
    ...
    },
    {
      ...
      "chipIds": ["chip_eval_guard", "chip_postmortem"],
      "badges": ["NEW"],
      "minutesMock": 7,
    ...
    },
    {
      ...
      "source": "bearblog",
      "author": "karpathy",
      "chipIds": ["chip_postmortem", "chip_ops"],
      "badges": ["추천"],
      "minutesMock": 6,
    ...
    },
    {
      ...
      "source": "boot.dev",
      "author": "boot.dev",
      "chipIds": ["chip_postmortem", "chip_eval_guard"],
      "badges": [],
      "minutesMock": 6,
    ...
    },
    {
      ...
      "source": "ITPro",
      "author": "ITPro",
      "chipIds": ["chip_tools_mcp", "chip_eval_guard"],
      "badges": [],
      "minutesMock": 8,
    ...
    },
    {
      ...
      "source": "n8n Docs",
      "author": "n8n",
      "chipIds": ["chip_automation", "chip_rag_ctx"],
      "badges": [],
      "minutesMock": 10,
      "statsMock": { "views": 9000, "likes": 120, "comments": 8 },
    ...
    },
    {
      ...
      "source": "Wikidocs",
      "author": "Wikidocs",
      "chipIds": ["chip_agent_blueprint", "chip_tools_mcp"],
      "badges": ["KOR"],
      "minutesMock": 10,
    ...
    },
    {
      ...
      "source": "Wikidocs",
      "author": "Wikidocs",
      "chipIds": ["chip_rag_ctx", "chip_agent_blueprint"],
      "badges": ["KOR"],
      "minutesMock": 12,
